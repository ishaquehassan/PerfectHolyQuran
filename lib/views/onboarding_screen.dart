...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Future getUserLocation() async {
    ...
    print('${first.locality}, ${first.administrativeArea}');
    currentAddress = '${first.locality} ${first.administrativeArea}';
    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          ...
          body:
              "You can watch Madina & Makkah updates, Addhan, everything live in our app",
        ...
        PageViewModel(
          ...
          body:
              "Now you don't worry about Qibla direction we can find it for you.",
      ...
      skip: const Text('Skip',
          style:
              TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF0dd1a7))),
